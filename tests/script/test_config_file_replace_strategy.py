...
FILES = [
    {
        ...
        'strategy': {
            'type': 'replace',
            'serializers': ['Version: {{major}}.{{minor}}']
        }
    }
]
...
def test_update_minor(test_environment):
    ...
    assert test_environment.get_file_content("README.md") == "Version: 1.1"
...
def test_update_patch(test_environment):
    ...
    assert test_environment.get_file_content("README.md") == "Version: 1.0"
