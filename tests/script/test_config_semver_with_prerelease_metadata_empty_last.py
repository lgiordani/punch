...
def test_update_major(test_environment):
    ...
    assert test_environment.get_file_content("README.md") == "Version 2.0.0-alpha"
...
def test_update_minor(test_environment):
    ...
    assert test_environment.get_file_content("README.md") == "Version 1.1.0-alpha"
...
def test_update_patch(test_environment):
    ...
    assert test_environment.get_file_content("README.md") == "Version 1.0.1-alpha"
